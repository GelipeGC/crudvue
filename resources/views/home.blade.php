...
@section('content')
    <div class="container">
        <div class="columns personal-menu text-center vertical-center margiin0">
            <div class="column">
                Zona de pruebas
            </div>
        </div>
        <div class="columns margin0 title">
        ...
        <div class="columns margin0 text-center vertical-center personal-menu">
            ...
            <div class="column">Cargos @{{ positions.length}}</div>
        </div>
    </div>
   @include('modal')
@endsection
    ...
    <script>
        let elemento = new Vue({
            ...
            methods: {
                    ...
                    switch (type) {
                        ...
                        case "position":
                        {
                            switch (action) {
                                ...
                                {
                                    this.modalGeneral = 1;
                                    this.titleModal = 'Eliminación de un Cargo';
                ...
                destroyPosition(){
                    let me = this;
                    axios.post('{{ url('/position/delete')}}'+'/'+this.idPosition)
                    .then(function (response){
                        me.titlePosition = '';
                        me.errorTitlePosition = 0;
                        me.modalPosition = 0;
